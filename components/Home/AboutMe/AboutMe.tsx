...
export default function AboutMe(props) {
  const technologies = [
    ["Java", "JavaScript (ES6+)", "MaterialUI", "React", "MondoDB", "AWS"],
    ["Node.js", "TypeScript", "Python", "NestJS", "Terraform", "PostgreSQL"],
  ];
  return (
          ...
          <div className="w-full md:w-7/12 space-y-4 sm:text-base text-sm ">
            <div className="font-Header ">
              <span className="text-gray-400 ">
                Hello! My name is Paul and I enjoy creating things that live on the internet. My interest in web development started back in 2021 when I started designing simple web pages using HTML & CSS!
              </span>
            </div>
            <div className="font-Header ">
              <span className="text-gray-400 ">
                I’ve had the privilege to learn from many people along the way and will continue this journey as a life long learner!
              </span>
            </div>
